...
import velka.lang.compiler.Main;
...
// 		}
	...
	void testDefExpression() throws AppendableException {
		...
		p = recursiveExpression.infer(Environment.topLevelEnvironment);
	...
	void testLambda() throws AppendableException {
		...
		Assertions.assertThrows(TypesDoesNotUnifyException.class,
				() -> this.parseString("(lambda ((String x)) (+ x x))").infer(Environment.topLevelEnvironment));
	}
	...
	void testFunction() throws AppendableException {
		...
		Assertions.assertThrows(TypesDoesNotUnifyException.class,
				() -> this.parseString("(lambda ((String x)) (+ x x))").interpret(Environment.topLevelEnvironment)
						.infer(Environment.topLevelEnvironment));
	}

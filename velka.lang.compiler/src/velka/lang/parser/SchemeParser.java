...
public class SchemeParser extends Parser {
	...
	public static class ArrowContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SchemeListener ) ((SchemeListener)listener).enterArrow(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SchemeListener ) ((SchemeListener)listener).exitArrow(this);
		}
	}
	...
	public final ArrowContext arrow() throws RecognitionException, AppendableException {
		...
		try {
			...
			setState(77);
			match(T__1);
			 ((ArrowContext)_localctx).val =  SemanticNode.make(SemanticNode.NodeType.ARROW, new velka.lang.util.Pair<SemanticNode, SemanticNode>(lvalue, ((ArrowContext)_localctx).expr.val)); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;

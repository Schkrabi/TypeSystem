...
public class VelkaParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, TRUE=27, FALSE=28, INT=29, FLOAT=30, COMMENT=31, WS=32, 
		STRING=33, ARROW=34, LBRACKET=35, LSBRACKET=36, RBRACKET=37, RSBRACKET=38, 
		COLLON=39, SYMBOL=40;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'list'", "'loop'", "'or'", "'recur'", "'lambda'", "'extended-lambda'", 
			"'let'", "'let*'", "'let-type'", "'tuple'", "'eapply'", null, null, null, 
			null, null, null, null, "'#>'", "'('", "'['", "')'", "']'", "':'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "TRUE", "FALSE", "INT", "FLOAT", "COMMENT", "WS", "STRING", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1144474566658L) != 0)) {
				{
				{
				setState(27);

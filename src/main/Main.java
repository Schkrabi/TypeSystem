...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Expression expr = new Application(new Lambda(new Variable("_y"), new Application(new Lambda(new Variable("_x"), Add.singleton), LitInteger.initializeDefaultImplementation(4))), LitInteger.initializeDefaultImplementation(5));
